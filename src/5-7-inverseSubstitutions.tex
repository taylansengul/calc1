...
% \subsection*{The Inverse Secant Substitution}
% If an integral involves $\sqrt{x^2-a^2}$, try the substitution $x = a \sec \theta$. We have to be more careful with this substitution.
\end{document}